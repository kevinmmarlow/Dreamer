...
public class BlurNetworkImageView extends ImageView {
     ...
     */
    public void setImageUrl(String url, ImageLoader imageLoader, ImageBlurrer imageBlurrer) {
        mUrl = url;
                ...
                new ImageLoader.ImageListener() {
                    ...
                    public void onResponse(final ImageLoader.ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                            ...
                            if (mImageBlurrer != null && !TextUtils.isEmpty(response.getRequestUrl())) {
                                mBlurredImageContainer = mImageBlurrer.blur(response.getBitmap(), response.getRequestUrl(), new ImageBlurrer.ImageBlurListener() {
                                    @Override
