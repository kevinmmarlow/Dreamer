...
import com.android.fancyblurdemo.volley.toolbox.ImageLoader.ImageContainer;
import com.android.fancyblurdemo.volley.toolbox.ImageLoader.ImageListener;
...
public class NetworkImageView extends ImageView {
    ...
    private ImageListener mExternalListener;
    ...
    public void setImageListener(ImageListener imageListener) {
        mExternalListener = imageListener;
    }
                ...
                new ImageListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (mExternalListener != null) {
                            mExternalListener.onErrorResponse(error);
                        }
                    }
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        ...
                        if (mExternalListener != null) {
                            mExternalListener.onResponse(response, isImmediate);
                        }
                    }
                }, maxWidth, maxHeight);
